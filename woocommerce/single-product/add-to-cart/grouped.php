...
/**
 *
 * This plugin modifies the add-to-cart form so that it redirects back to the
 * current page on SBS pages.
 *
 * @version 1.2.3
 *
*/
...
<?php if ( is_sbs() ): ?>
   <form class="cart" action="<?php echo esc_url( remove_query_arg('add-to-cart') ); ?>" method="post" enctype='multipart/form-data'>
<?php else: ?>
